...
**Inclusion bar:** Include camera ops players meet on the ship Maps+ surface, feel/preset language, and rewrite plane / resolve terms used in feature or client shards. Omit unfinished-module jargon unless a shard must disambiguate it from ship UI. Prefer platform-neutral wording; put OS brand names in platform notes.

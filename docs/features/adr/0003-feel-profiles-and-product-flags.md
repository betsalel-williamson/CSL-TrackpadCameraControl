...
3. **Sensitivity.** Canonical term is **Sensitivity** (synonyms: speed, scale, drag scale). Product numeric sensitivities are **> 0** and round/display/apply to **two decimal places**.

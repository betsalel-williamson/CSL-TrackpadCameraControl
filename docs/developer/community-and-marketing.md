...
Maintainer playbook for **where** Trackpad Camera Control builds buzz, **when** to announce, and **how** to stay honest about platform and maturity. Player-facing install steps stay in the client guide (`docs/client/install-and-first-run.md`); packaging mechanics stay in [commits and releases](./release-process.md).
...
Product names and search keywords: [repository layout](./repository-layout.md). Paste-ready Workshop title, description, and tags: [Workshop storefront](./workshop-storefront.md). Personas: `docs/client/personas.md`.

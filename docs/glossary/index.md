...
Shared terms for product and architecture contracts. Prefer condensed local entries so MDCP compile stays closed.

**Inclusion bar:** Include camera ops players meet on the ship Maps+ surface, feel/preset language, [UI parity](./ui-parity.md) vs source clone, [gesture library](./gesture-library.md) / [mod surface](./mod-surface.md) stack terms, and plane / resolve terms used in feature or client shards. Omit unfinished-module jargon unless a shard must disambiguate it from ship UI. Prefer platform-neutral wording; put OS brand names in platform notes.

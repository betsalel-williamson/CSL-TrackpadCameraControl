...
5. Open Options → Trackpad Camera Control to adjust Sensitivity sliders or Slow / Default / Fast from the feel dropdown. Pitch angle limits (7–90°) live on the [Debug panel](./debug-ui.md) if you need them.
